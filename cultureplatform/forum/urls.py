...
urlpatterns = [
    ...
    url('/categories/mental_health/<int:year>/', views.mental_health, name='mental_health'),
    url('/categories/miscellaneous/<int:year>/', views.miscellaneous, name='miscellaneous'),
